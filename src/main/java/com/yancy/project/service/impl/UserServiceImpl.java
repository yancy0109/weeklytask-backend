...
import static com.yancy.project.constant.UserConstant.ADMIN_ROLE;
import static com.yancy.project.constant.UserConstant.USER_LOGIN_STATE;
...
//    @Transactional
    public long userRegister(String userAccount, String userName, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            if (count > 0) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "用户昵称重复");
            }
            // 2. 加密
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        currentUser = getSafetyUser(currentUser);
        if (currentUser == null) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
        }
        return currentUser;
